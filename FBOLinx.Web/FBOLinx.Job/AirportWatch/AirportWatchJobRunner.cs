...
namespace FBOLinx.Job.AirportWatch
{
    public class AirportWatchJobRunner : IJobRunner
    {
        ...
        private ModelMapperService _modelMapperService = new ModelMapperService();
        ...
        private async void OnChanged(object source, FileSystemEventArgs e)
        {
            ...
            List<AirportWatchLiveData> airportWatchData = _modelMapperService.ConvertToDBModel(data);
