    ...
    fboId, request.StartDateTime.GetValueOrDefault(), request.EndDateTime.GetValueOrDefault(), request.FlightOrTailNumbers, icao);
            ...
            customerVisitsData = historicalData
               ...
               .Select(g =>
               {
                   ...
                   visitsToMyFboCount = (latestHistoricalParking?.AirportWatchHistoricalParking == null && latest?.AircraftStatusDescription == FBOLinx.Core.Utilities.Enums.EnumHelper.GetDescription(latest?.AircraftStatus)) ? visitsToMyFboCount : visitsToMyFboCount;
