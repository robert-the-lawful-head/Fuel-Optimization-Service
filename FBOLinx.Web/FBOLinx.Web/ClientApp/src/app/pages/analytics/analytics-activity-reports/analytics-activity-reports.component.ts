...
export class AnalyticsActivityReportsComponent implements OnInit {
    ...
    defaultHiddenReports : AnaliticsReportType[] = [AnaliticsReportType.FuelerLinxCustomerCaptureRate];
    singleSourceFbotHiddenReports : AnaliticsReportType[] = [AnaliticsReportType.LostToCompetition];
    nonNetworkHiddenReports : AnaliticsReportType[] = [AnaliticsReportType.FBONetworkArrivalDepartures];
