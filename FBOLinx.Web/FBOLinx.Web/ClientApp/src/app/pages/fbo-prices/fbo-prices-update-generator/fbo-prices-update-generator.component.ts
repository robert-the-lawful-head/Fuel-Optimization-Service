...
export class FboPricesUpdateGeneratorComponent implements OnInit {
    ...
    // Methods
    public onEditFboPrice(pricingUpdateGridViewModel: pricingUpdateGridViewModel): void {
        this.fboPricesUpdateGridItem = pricingUpdateGridViewModel;
    }
    ...
    //updatePricing() {
    //    const effectiveFrom = moment(this.currentPricingEffectiveFrom).format(
    //        'MM/DD/YYYY'
    //    );
    //    const effectiveTo = moment(this.currentPricingEffectiveTo)
    //        .add(1, 'day')
    //        .format('MM/DD/YYYY');
    //    const newPrices = [];
    ...
    //        this.temporaryAddOnMargin.update(payload).subscribe(() => {
    ...
    //    this.temporaryAddOnMargin.remove(this.TempValueId).subscribe(() => {
    ...
    //        this.fboPricesService.suspendPricing(oid).subscribe(() => {
        ...
        this.fboPricesService
            ...
            .subscribe(
                (data: any) => {
                    ...
                    var fboAirportService = this.fboairportsService;
                    ...
                    this.fboPricesUpdateGridData.forEach(function (fboPrice) {
                        if (fboPrice.effectiveFrom && (fboPrice.oidPap == 0 || fboPrice.oidPap == undefined)) {
                            fboAirportService.getLocalDateTime(fboPrice).subscribe((localdatetime: any) => {
                        ...
                        fboPrice.isLoading = false;
                    });

                    //this.stagedFboPriceSaf =
                    //    this.getStagedPriceByProduct('SAF');
                    ////this.stagedFboPriceJetARetail =
                    ////    this.getStagedPriceByProduct('JetA Retail');
                    //if (this.stagedFboPriceSaf.effectiveTo) {
                    //    this.stagedFboPriceSaf.effectiveTo =
                    //        moment(
                    //            this.stagedFboPriceSaf.effectiveTo
                    //        ).subtract(1, 'minutes');
                    //}
    ...
    //    const effectiveFrom = moment(this.stagedPricingEffectiveFrom).format(
    //        'MM/DD/YYYY'
    //    );
    //    const effectiveTo = moment(this.stagedPricingEffectiveTo)
    //        .add(1, 'day')
    //        .format('MM/DD/YYYY');
    ...
    //        ).add(1, 'days');
    //        this.stagedPricingEffectiveFrom = new Date(
    //            tempStagedPricingEffectiveFrom.format('MM/DD/YYYY')
    //        );
    //    } else if (
    //        !this.stagedPricingEffectiveFrom &&
    //        this.currentFboPriceJetACost.effectiveTo
