...
import { AircraftFlightWatchService } from '../flight-watch-map/flight-watch-map-services/aircraft-flight-watch.service';
import { FboFlightWatchService } from '../flight-watch-map/flight-watch-map-services/fbo-flight-watch.service';
import { AircraftImageData, AIRCRAFT_IMAGES } from '../flight-watch-map/aircraft-images';
...
@Component({
    ...
    selector: 'app-flight-watch-map-only',
    styleUrls: ['./flight-watch-map-only.component.scss'],
    templateUrl: './flight-watch-map-only.component.html',
})
export class FlightWatchMapOnlyComponent
    ...
    implements OnInit, OnChanges, OnDestroy
{
    ...
    async clickHandler(
        ...
        self: FlightWatchMapOnlyComponent
    ) {
