...
export class CustomeraircraftsService {
    ...
    public getCustomerAircraftsByGroupAndCustomerId(groupId, fboId, customerId) {
        return this.http.get(this.accessPointUrl + '/group/' + groupId + '/fbo/' + fboId + '/customer/' + customerId, { headers: this.headers });
    }
    ...
    public getCustomerAircraftsCountByGroupId(groupId) {
        return this.http.get(this.accessPointUrl + '/group/' + groupId + '/count', { headers: this.headers });
    }
