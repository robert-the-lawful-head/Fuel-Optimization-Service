...
export class CustomerinfobygroupService {
    ...
    public getCustomerCountByGroupAndFBO(groupId, fboId) {
        return this.http.get(this.accessPointUrl + '/group/' + groupId + '/fbo/' + fboId + '/count', { headers: this.headers });
    }

    public getCustomersByGroupAndFBOAndPricing(groupId, fboId, pricingTemplateId) {
        return this.http.get(this.accessPointUrl + '/group/' + groupId + '/fbo/' + fboId + '/pricingtemplate/' + pricingTemplateId, { headers: this.headers });
    }
    ...
    public getCertificateTypes() {
        return this.http.get(this.accessPointUrl + '/CertificateTypes', { headers: this.headers });
    }
