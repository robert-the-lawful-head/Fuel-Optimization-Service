...
export class UserService {
    ...
    public getCurrentUser() {
        return this.http.get(this.accessPointUrl + '/current', { headers: this.headers });
    }
    ...
    public getRoles() {
        return this.http.get(this.accessPointUrl + '/roles', { headers: this.headers });
    }

    public resetPassword(payload) {
        return this.http.post(this.accessPointUrl + '/resetpassword', payload, { headers: this.headers });
    }
