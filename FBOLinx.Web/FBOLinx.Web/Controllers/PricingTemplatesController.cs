        ...
        public async Task<IActionResult> GetPricingTemplateByFboId([FromRoute] int fboId)
        {
            ...
            var result = await (from p in _context.PricingTemplate
                ...
                select new PricingTemplatesGridViewModel
                {
                    ...
                    IsInvalid = (f != null && f.Preferences != null && ((f.Preferences.OmitJetACost.GetValueOrDefault() && p.MarginType.GetValueOrDefault() == Models.PricingTemplate.MarginTypes.CostPlus) || (f != null && f.Preferences != null && f.Preferences.OmitJetARetail.GetValueOrDefault() && p.MarginType.GetValueOrDefault() == Models.PricingTemplate.MarginTypes.RetailMinus))) ? true : false,
