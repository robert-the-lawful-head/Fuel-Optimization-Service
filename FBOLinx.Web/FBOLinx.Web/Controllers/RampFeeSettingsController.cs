...
namespace FBOLinx.Web.Controllers
{
    ...
    [ApiController]
    public class RampFeeSettingsController : FBOLinxControllerBase
    {
        private readonly FboLinxContext _context;

        public RampFeeSettingsController(FboLinxContext context, ILoggingService logger) : base(logger)
        {
            _context = context;
        }
