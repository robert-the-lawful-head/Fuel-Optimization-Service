...
[**GetCurrentPricing**](FuelPricingApi.md#getcurrentpricing) | **GET** /api/FuelPricing/current | Internal use only - Fetch all cached pricing
...
namespace Example
{
    public class GetCurrentPricingExample
    {
        public void main()
        {
            ...
            {
                // Internal use only - Fetch all cached pricing
                CurrentPricingResponse result = apiInstance.GetCurrentPricing();
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling FuelPricingApi.GetCurrentPricing: " + e.Message );
            }
        }
    }
}
