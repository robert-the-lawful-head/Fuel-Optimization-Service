...
namespace IO.Swagger.Model {
  ...
  public class AccountingContractMappingsDTO {
    ...
    /// <summary>
    /// Gets or Sets AcukwikFboHandlerLookup
    /// </summary>
    [DataMember(Name="acukwikFboHandlerLookup", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "acukwikFboHandlerLookup")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  AcukwikFboHandlerLookup: ").Append(AcukwikFboHandlerLookup).Append("\n");
