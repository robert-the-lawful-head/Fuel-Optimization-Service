...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PostAirportDetailsByCompanyNotesRequest {
    /// <summary>
    /// Gets or Sets AirportDetailsByCompanyId
    /// </summary>
    [DataMember(Name="airportDetailsByCompanyId", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "airportDetailsByCompanyId")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class PostAirportDetailsByCompanyNotesRequest {\n");
      sb.Append("  AirportDetailsByCompanyId: ").Append(AirportDetailsByCompanyId).Append("\n");
