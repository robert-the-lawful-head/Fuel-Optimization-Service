...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PostFboDetailsByCompanyNotesRequest {
    /// <summary>
    /// Gets or Sets FboByCompanyId
    /// </summary>
    [DataMember(Name="fboByCompanyId", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "fboByCompanyId")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class PostFboDetailsByCompanyNotesRequest {\n");
      sb.Append("  FboByCompanyId: ").Append(FboByCompanyId).Append("\n");
